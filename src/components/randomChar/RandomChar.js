...
const RandomChar = () => {
    ...
    const {loading, error, getCharacter, clearError} = useMarvelService();//this.marvelSerice свойство класса теперь
    ...
    const content = !(loading || error) ? <View char={char}/> : null;//если нет загрузки или нет ошибки то вернуть отрисовку всей страницы
